...
\definecolor{50}{HTML}{FFD6CC}
\definecolor{100}{HTML}{FF5C33}
\definecolor{200}{HTML}{E48221}
\definecolor{300}{HTML}{D8470A}
\definecolor{400}{HTML}{78909C}
\definecolor{500}{HTML}{9E2101}
\definecolor{600}{HTML}{546E7A}
\definecolor{700}{HTML}{455A64}
\definecolor{800}{HTML}{37474F}
\definecolor{900}{HTML}{4D0000}
...
\newcommand{\asignatura}{%
  Geometría II:\\
  Formas bilineales y cuaráticas\\
}

\newcommand{\autor}{Paula Villanueva (apuntes originales) \\ Manuel Gachs Ballegeer (transcripción)}

\newcommand{\grado}{Doble grado ingeniería informática y matemáticas}

\newcommand{\universidad}{Universidad de Granada}

\newcommand{\enlaceweb}{github.com/DGIIMUnderground/DGIIM1}
...
\parbox[t]{\textwidth}{
  \includegraphics{/home/manuel/by-nc-sa.pdf}\\[4pt]
  \raggedright % Texto alineado a la izquierda
  \sffamily\large
